...
class DataModel extends ChangeNotifier {
  ...
  void update(Person updatedPerson) {
    ...
    ///this is using the Equitable part we wrote so its going through all the person
    ///instances in this people list and is going through every one of them and calling
    ///the equality function on them and then it says is that person equal to this person
    ///and if it is we get the index right here.
